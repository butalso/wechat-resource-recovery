        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    <a href="#" class="dropdown-toggle">
                        <i class="icon-list"></i>
                        <span class="menu-text">回收员管理</span>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="menu-text">兑换管理</span>
                    </a>
                </li>
...
<script src="/web-consumer/static/manager/jquery/2.0.3/jquery.min.js"></script>

<!-- <![endif]-->

<!--[if IE]>
<script src="/web-consumer/static/manager//jquery/1.10.2/jquery.min.js"></script>
<![endif]-->
...
<script type="text/javascript" src="/web-consumer/static/manager/produceChart.js">
