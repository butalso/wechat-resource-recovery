...
function modify() {
    ...
    $("#statusChang>li:gt(0)").on("click",function (e) {
        e.preventDefault();
        var value=$(this).children("a:first-child").text();
        var style=$(this).find("i").attr("class");
        $("#statuShow").children(":first-child").attr("class",style)
    })
...
function submitModify() {
    var modifyDatas={};
    modifyDatas["name"]=$("#username").text();
